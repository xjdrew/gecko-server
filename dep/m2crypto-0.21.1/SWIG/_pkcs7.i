...
%threadallow i2d_pkcs7_bio;
%inline %{
int i2d_pkcs7_bio(BIO *bio, PKCS7 *pkcs7) {
    return i2d_PKCS7_bio(bio, pkcs7);
}
%}
%inline %{
%}
/* i2d_PKCS7_bio_stream enable from openssl 1.0
%threadallow i2d_pkcs7_bio_stream_multi;
%inline %{
int i2d_pkcs7_bio_stream_multi(BIO *bio, PKCS7 *pkcs7, BIO *data, int flags) {
    return i2d_PKCS7_bio_stream(bio, pkcs7, data, flags);
}
%}


%threadallow i2d_pkcs7_bio_stream;
%inline %{
int i2d_pkcs7_bio_stream(BIO *bio, PKCS7 *pkcs7, int flags) {
    return i2d_PKCS7_bio_stream(bio, pkcs7, NULL, flags);
}
%}
*/
